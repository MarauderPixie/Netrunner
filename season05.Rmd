...
**+++ DISCLAIMER +++**  
Offensichtlich stimmt irgendwas mit den Agendapunkten nicht, ich finds aber auf die Schnelle nicht. :/
...
s5 %>% 
  ...
  # mutate(
    # add points frm achievements by hand, like an animal
    # Achievements = c(5, 2, 1, 4, 1, 4, 0, 4, 2),
    # Gesamtpunkte = Gesamtpunkte + Achievements
  # ) %>% 
